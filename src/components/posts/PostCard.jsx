    ...
    <div className="bg-bg-secondary rounded-xl p-4 border border-border">
      ...
      <div className="flex items-center gap-6 pt-2 border-t border-border">
        ...
        <button
          ...
          className="flex items-center gap-2 text-text-secondary hover:text-accent transition-colors ml-auto"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    return (
                      <div key={reply.id} className="pl-4 border-l-2 border-border">
                        <div className="flex items-start gap-3">
                          <Link to={reply.author?.artist_slug ? `/profile/${reply.author.artist_slug}` : `/profile/${reply.user_id}`}>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <Link
                                to={reply.author?.artist_slug ? `/profile/${reply.author.artist_slug}` : `/profile/${reply.user_id}`}
