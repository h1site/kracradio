        ...
        {!user && !authLoading ? (
          <div className="flex items-center justify-center min-h-[300px]">
            <div className="text-center">
              ...
              <button onClick={() => navigate('/login')} className="px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-full transition-colors">
                Se connecter
              </button>
            </div>
          </div>
                        ...
                        <div className="p-4 flex items-center gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            {playlist.videos.length > 0 && (
                              <button onClick={() => navigate(`/playlist/video/${playlist.id}`)} className="p-2 bg-red-500 hover:bg-red-600 text-white rounded-full transition-colors" title="Lire la playlist">
                                <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor"><path d="M8 5v14l11-7z" /></svg>
                              </button>
                            )}
                            <button onClick={() => setExpandedPlaylist(expandedPlaylist === playlist.id ? null : playlist.id)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors">
