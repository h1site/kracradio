...
export default function VideoPlaylistPlayer() {
  ...
  }, [playlist, videoPlaylists, navigate]);
      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center bg-black">
          <div className="text-center">
            ...
            <Link to="/playlists" className="px-6 py-3 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors inline-block">
