...
// Helper to save playlists to localStorage
...
export function PlaylistProvider({ children }) {
  // Song playlists state
  const [songPlaylists, setSongPlaylists] = useState(() => loadFromStorage(SONG_PLAYLISTS_KEY));
  // Video playlists state
  const [videoPlaylists, setVideoPlaylists] = useState(() => loadFromStorage(VIDEO_PLAYLISTS_KEY));

  // Persist song playlists to localStorage
  useEffect(() => {
    saveToStorage(SONG_PLAYLISTS_KEY, songPlaylists);
  }, [songPlaylists]);

  // Persist video playlists to localStorage
  useEffect(() => {
